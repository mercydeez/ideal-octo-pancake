...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(56, 189, 248, 0.4) 0%, rgba(129, 140, 248, 0.2) 100%)';
...
const clamp = (v: number, min: number = 0, max: number = 100) => Math.min(Math.max(v, min), max);
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(56, 189, 248, 0.4)',
